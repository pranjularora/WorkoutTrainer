...
public class WorkoutDataInstruction {
    List<Map<String,?>> workoutList;
    DatabaseReference mRef;
    MyFirebaseRecyclerAdapterInstruction myFirebaseRecyclerAdapterInstruction;
    Context mContext;

    public void setAdapter(MyFirebaseRecyclerAdapterInstruction mAdapter) {
        myFirebaseRecyclerAdapterInstruction = mAdapter;
    }
